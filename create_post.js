const IMAGE_TMDB_BASE_URL = "https://image.tmdb.org/t/p/w500";
...
function doSomething(info) {
    ...
    image.src = IMAGE_TMDB_BASE_URL + info['poster_path'];
    ...
    cardTitle.textContent = info['original_title'];
...
function submitHandler(event) {
    ...
    function jsonHandler(textRes) {
        ...
        if (search_form.elements['service_select'].value == 'TMDB') {

            try {
                infos = JSON.parse(textRes)['results'];
            } catch (e) {
