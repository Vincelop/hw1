...
<div class="container">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark mb-2">
        <a class="navbar-brand" href="./home.php"><img src="favicon_red.png" width="32" height="32" alt="Pc di legno" class="d-inline-block mr-1">CineAddicted</a>
            ...
            <div class="modal-content">
                <form id="modal_form">
                    <div class="modal-header">
                        <h5 class="modal-title" id="post_modal_label">Write a comment</h5>
                        <button type="button" class="close" data-dismiss="modal">
                            <span>&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <label for="title">Write a comment</label>
